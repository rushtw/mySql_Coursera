CREATE DATABASE luckyshrub_db_2; 
USE luckyshrub_db_2;
...
SELECT EmployeeID, HandlingCost FROM employee_orders WHERE HandlingCost > ALL(SELECT OrderTotal*0.2 FROM orders);

SELECT EmployeeID, HandlingCost FROM employee_orders WHERE HandlingCost > ALL(SELECT OrderTotal*0.2 FROM orders) GROUP BY EmployeeID,HandlingCost;

SELECT COUNT(*) FROM employee_orders GROUP BY OrderID;
